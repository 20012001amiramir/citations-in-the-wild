...
import { registryMethodOf, mapVerdict, declaredChecks, scoreResult, computeMetrics, isAggregateRecord, dropAggregates, dropUnscoreable, declaresOnlyExistsSays } from './score.mjs';
