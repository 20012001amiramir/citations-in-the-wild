...
import { registryMethodOf, registryReasonOf, insufficientReason, insufficientSplit, mapVerdict, declaredChecks, scoreResult, computeMetrics, isAggregateRecord, dropAggregates, dropUnscoreable, declaresOnlyExistsSays } from './score.mjs';
...
describe('computeMetrics', () => {
  ...
  test('insufficientSplit: the citations with no verdict, by whose limit it was', () => {
    ...
    const rows = [
      ...
      { predicted: 'INSUFFICIENT', exists_verdict: 'SOURCE_UNREACHABLE', registry_reason: null },
